...
export default function Home({ guides, tutorials }) {
  return (
    <>
      {/** Hero */}
      ...
      <div className="py-24 mt-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex items-center space-x-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">Guides</h2>
          </div>
...
> => {
  const guides = await getMdFiles("guides")
  const tutorials = await getMdFiles("tutorials")

  return {
    props: { guides, tutorials },
  };
};
